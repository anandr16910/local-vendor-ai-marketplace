...
# Simplified Backend Setup Script for EC2 Instance
...
FRONTEND_URL=https://local-vendor-ai-marketplace.vercel.app
CORS_ORIGIN=https://local-vendor-ai-marketplace.vercel.app
